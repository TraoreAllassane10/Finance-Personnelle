...
class ExcelEpargne extends Excel
{
    public function download(Collection $datas, string $nameFile)
    {
        ...
        $columns = ["ID", "Montant", "Date", "Description"];
        ...
        foreach ($datas as $data){
            ...
            $sheet->setCellValue("C$rowNumber", $data->date);
            $sheet->setCellValue("D$rowNumber", $data->projets);
